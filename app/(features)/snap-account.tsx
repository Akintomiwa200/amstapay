  ...
  return (
    <View style={[styles.container, { backgroundColor: c.bg }]}>
      <LinearGradient colors={[c.primaryLight, c.bg]} style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { color: c.primary }]}>Snap Account</Text>
        <View style={{ width: 40 }} />
      </LinearGradient>

      <ScrollView contentContainerStyle={styles.content}>
        <View style={[styles.instructionCard, { backgroundColor: c.surfaceContainer }]}>
          <Scan size={24} color={c.primary} />
          <Text style={[styles.instructionTitle, { color: c.primary }]}>Snap Account Details</Text>
          <Text style={[styles.instructionText, { color: c.textSub }]}>
        ...
        {image ? (
          ...
          <View style={[styles.placeholderContainer, { backgroundColor: c.surfaceContainer }]}>
            ...
            <Text style={[styles.placeholderText, { color: c.textSub }]}>No image captured yet</Text>
          </View>
        )}
        ...
        {extractedData.accountNumber ? (
          <View style={[
            ...
            { borderColor: extractedData.type === 'crypto' ? '#FFD700' : extractedData.type === 'nigerian' ? '#008751' : c.success },
          ]}>
            ...
            <View style={styles.resultRow}>
              <Text style={[styles.resultLabel, { color: c.textSub }]}>Account Number:</Text>
              <Text style={[styles.resultValue, { color: c.primary }]}>{extractedData.accountNumber}</Text>
            </View>
            
            {extractedData.bankName ? (
              <View style={styles.resultRow}>
                <Text style={[styles.resultLabel, { color: c.textSub }]}>Bank/Wallet:</Text>
                <Text style={[styles.resultValue, { color: c.primary }]}>{extractedData.bankName}</Text>
              </View>
            ) : null}
            ...
            {extractedData.accountName ? (
              <View style={styles.resultRow}>
                ...
                <Text style={[styles.resultLabel, { color: c.textSub }]}>Account Name:</Text>
                <Text style={[styles.resultValue, { color: c.primary }]}>{extractedData.accountName}</Text>
              </View>
            ) : null}
        ...
        <View style={[styles.supportedList, { backgroundColor: c.surfaceContainer }]}>
          <Text style={[styles.supportedTitle, { color: c.primary }]}>Supported:</Text>
          <Text style={[styles.supportedText, { color: c.textSub }]}>✓ Nigerian Banks (Access, GTB, Zenith, First Bank, UBA, etc.)</Text>
          <Text style={[styles.supportedText, { color: c.textSub }]}>✓ International Banks (Chase, HSBC, Barclays, etc.)</Text>
          <Text style={[styles.supportedText, { color: c.textSub }]}>✓ Crypto Wallets (Ethereum, Bitcoin, Solana)</Text>
          <Text style={[styles.supportedText, { color: c.textSub }]}>✓ Auto-detects account name & bank</Text>
        </View>
      </ScrollView>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  instructionTitle: { fontSize: 18, fontWeight: '700', marginTop: 12, marginBottom: 8 },
  ...
  supportedList: { borderRadius: 12, padding: 16 },
  supportedTitle: { fontSize: 14, fontWeight: '700', marginBottom: 8 },
  supportedText: { fontSize: 12, marginBottom: 4, lineHeight: 18 },
});
